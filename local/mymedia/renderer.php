...
require_once(dirname(dirname(dirname(__FILE__))) . '/local/mymedia/download_media.php');
...
class local_mymedia_renderer extends plugin_renderer_base {
    ...
    public function create_sort_option() {
        ...
        $sort = '';
        $sort .= get_string('sortby', 'local_mymedia') . ':' . '&nbsp;';
    ...
    public function create_media_name_markup($name, $internal) {
        ...
        $output .= html_writer::start_tag('div', $attr);
        if ($internal == true) {
            $name = $name . '(' . get_string('internal', 'local_mymedia') . ')';
        }
    ...
    public function create_media_access_link_markup($entry, $page = 0, $sort = 'recent') {
        ...
        $attr   = array('class' => 'mymedia media access',
                        'href' => new moodle_url('/local/mymedia/access_media.php',
                        array('entryid' => $entry->id, 'page' => $page, 'sort' => $sort))
                        );

        $output .= html_writer::start_tag('a', $attr);
        $output .= get_string('access_link', 'local_mymedia');
        $output .= html_writer::end_tag('a');
    ...
    public function create_media_delete_link_markup($entry, $page = 0, $sort = 'recent') {
        ...
        $attr = array('class' => 'mymedia media delete',
                      'href' => new moodle_url('/local/mymedia/delete_media.php',
    ...
    public function create_media_download_link_markup($entry) {
        ...
        if ($originallink != '') {
            ...
            $output .= html_writer::start_tag('a', $attr);
            $output .= get_string('download_link', 'local_mymedia');
            $output .= html_writer::end_tag('a');
            return $output;
        }
    ...
    public function create_media_entry_markup($entry, $entryready = true, $page, $sort, $accesscontrol) {
        ...
        if ($entryready) {
            ...
            $output .= $this->create_media_name_markup($entry->name . ' (' .
                                                       get_string('converting', 'local_mymedia') . ')', $internal);
    ...
    public function media_metadata_form() {
        ...
        $output .= html_writer::tag('label', get_string('metadata_media_name', 'local_mymedia'));
        ...
        $attr = array('type' => 'text',
                      ...
                      'title' => get_string('metadata_media_name', 'local_mymedia'));
        ...
        $output .= html_writer::tag('label', get_string('metadata_media_tags', 'local_mymedia'));
        ...
        $attr = array('type' => 'text',
                      ...
                      'title' => get_string('metadata_media_tags', 'local_mymedia'));
        ...
        $output .= html_writer::tag('label', get_string('metadata_media_desc', 'local_mymedia'));
        ...
        $attr = array('rows' => '7',
                      ...
                      'title' => get_string('metadata_media_desc', 'local_mymedia'));
    ...
    public function create_media_details_table_markup($entry) {
        ...
        $output .= get_string('heading_summary', 'local_mymedia');
        ...
        $output .= html_writer::start_tag('tr');
        $output .= html_writer::start_tag('td');
        $output .= get_string('metadata_media_name', 'local_mymedia');
        $output .= html_writer::end_tag('td');
        $output .= html_writer::start_tag('td');
        $output .= $entry->name;
        $output .= html_writer::end_tag('td');
        ...
        $output .= html_writer::start_tag('tr');
        $output .= html_writer::start_tag('td');
        $output .= get_string('metadata_media_created', 'local_mymedia');
        $output .= html_writer::end_tag('td');
        $output .= html_writer::start_tag('td');
        ...
        $output .= html_writer::start_tag('tr');
        $output .= html_writer::start_tag('td');
        $output .= get_string('metadata_media_tags', 'local_mymedia');
        $output .= html_writer::end_tag('td');
        $output .= html_writer::start_tag('td');
        $output .= $entry->tags;
        $output .= html_writer::end_tag('td');
        ...
        $output .= html_writer::start_tag('tr');
        $output .= html_writer::start_tag('td');
        $output .= get_string('metadata_media_desc', 'local_mymedia');
        $output .= html_writer::end_tag('td');
        $output .= html_writer::start_tag('td');
        $output .= $desc;
        $output .= html_writer::end_tag('td');
    ...
    public function create_embed_code_markup() {
        ...
        $output .= get_string('heading_link_type', 'local_mymedia');
        $output .= '&nbsp;&nbsp;';
        ...
        $array = array(0 => get_string('label_embed_code', 'local_mymedia'),
                       1 => get_string('label_page_url', 'local_mymedia')
                      );
        $selected = 0;
    ...
    public function create_access_control_markup($defaultcontrol, $internalcontrol, $currentcontrolid) {
        ...
        $output .= get_string('heading_access_control', 'local_mymedia');

        $output .= html_writer::end_tag('p');

        $array = array($defaultcontrol->id => get_string('default_access_control', 'local_mymedia'),
                       $internalcontrol->id => get_string('internal_access_control', 'local_mymedia'));
    ...
    public function create_entry_used_table($entryid, $mymediaurl, &$flag) {
        ...
        if ($resourcearray = $DB->get_records('kalmediares', array('entry_id' => $entryid))) {
            ...
            $output .= get_string('media_used', 'local_mymedia');
    ...
    public function create_delete_confirm_markup($entryid, $page, $sort, $mymediaurl) {
        ...
        $output .= html_writer::start_tag('div');
        $output .= get_string('delete_media_confirm', 'local_mymedia');
        $output .= html_writer::end_tag('div');
        ...
        $deletemediaurl = new moodle_url('/local/mymedia/delete_media.php',
