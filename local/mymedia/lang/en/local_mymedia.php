...
$string['mymedia:search'] = 'Search for uploaded media';
$string['mymedia:editmetadata'] = 'Edit media metadata';
$string['mymedia:sharecourse'] = 'Share media with courses';
$string['mymedia:sharesite'] = 'Share media with site';
$string['mymedia:upload'] = 'Upload a media';
$string['mymedia:delete'] = 'Delete uploaded media';
$string['mymedia:download'] = 'Download uploaded media';
$string['mymedia:clip'] = 'Create a clip of a media';
