...
M.local_mymedia.init_config = function (Y, panel_markup, dialog, conversion_script, save_media_script,
    ...
    loading_panel.setBody('<img src="/moodle/local/kaltura/pix/rel_interstitial_loading.gif" />');
    ...
    var check_conversion_status = {
        complete: function check_conversion_status (id, o) {
            ...
            if ('' == o.responseText) {
                tab_view.item(0).set('content', M.util.get_string("media_converting", "local_mymedia"));
            } else {
